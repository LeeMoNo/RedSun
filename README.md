...
运营人员在哪里校正
最省事：直接用 Cloudflare 自带的 D1 控制台。词典管理后台页面可以新增/编辑
打开 dash.cloudflare.com → Storage & databases → D1 → redsun-dict → Console，直接在网页里输 SQL 修改，不需要任何额外工具。

password=RS260520
https://test-admin-e77.pages.dev/admin.html


<!-- Flutter 分页查询接口用法 -->
// 查 N5 的词，第1页，每页10条
GET /entries?jlpt=N5&page=1&limit=10

// 查动词，第2页
GET /entries?pos=动词&page=2&limit=10

// 组合查询：N3 的名词
GET /entries?jlpt=N3&pos=名词&page=1&limit=20
